...
/**when delete is called the last element in the tree is deleted and 
 * when insert is called the item is placed at the root, with the value at the root moved to the 
 * end of the tree. 
*/
int TreeInsert(int item)
{
